      ...
      {chargement ? (
        ...
        <>
          <Card className="mb-4 flex items-center justify-between p-4">
            <div>
              <div className="text-xs uppercase tracking-wide text-ink/40">Point de vente</div>
              <div className="font-display text-sm font-semibold text-ink">{donnees.boutique.nom}</div>
            </div>
            <div className="text-right">
              <div className="text-xs uppercase tracking-wide text-ink/40">Téléphone</div>
              <div className="font-data text-sm font-medium text-ink">{donnees.boutique.telephone}</div>
            </div>
          </Card>
